...
__global__ void bitonicSort(float* a, int size);
__global__ void bitonicBuild(float* a, int size);
...
void bitonicSortRunner(float* a, int size) {
	...
	cudaMemcpy(array, a, size, cudaMemcpyHostToDevice);
 ...
 */
__global__ void bitonicSort(float* a, int blockSize) {
 ...
 */
__global__ void bitonicBuild(float* a, int blockSize, int t) {
